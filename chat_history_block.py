...
chat_history.write_records([
    MemoryRecord(message=BaseMessage.make_user_message(role_name="user", content="Hello,今天感觉怎么样？"),
                 role_at_backend=OpenAIBackendRole.USER),
    MemoryRecord(message=BaseMessage.make_assistant_message(role_name="assistant", content="我很好，谢谢！"),
